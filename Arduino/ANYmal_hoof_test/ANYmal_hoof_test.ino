...
void loop() {
  ...
  interrupts();
  Serial.print("Foot Sole IMU (m/s^2 / rad/s): ");
  Serial.print(fax1,6);
  Serial.print("\t");
  Serial.print(fay1,6);
  Serial.print("\t");
  ...
  Serial.print(fgz1,6);
  Serial.print("\t");
  Serial.println(ft1,6);

  Serial.print("Shank IMU (m/s^2 / rad/s): ");
  Serial.print(fax2,6);
  Serial.print("\t");
  Serial.print(fay2,6);
  Serial.print("\t");
  ...
  Serial.print(fgz2,6);
  Serial.print("\t");
  Serial.println(ft2,6);

  noInterrupts();
  Serial.print("Forces and Torques (N / Nm): ");
  Serial.print(forces[0],6);
  Serial.print("\t");
  Serial.print(forces[1],6);
  Serial.print("\t");
